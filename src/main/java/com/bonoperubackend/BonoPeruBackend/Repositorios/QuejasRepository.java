...
public interface QuejasRepository extends JpaRepository<Quejas,Integer>{
    ...
    ArrayList<ArrayList<Object>> reportequejas(LocalDate fechaini, LocalDate fechafin, Integer iddepartamento, Integer idprovincia, Integer iddistrito, List<Integer> cronogramas);
    ...
    @Query(value="select c.idcronograma, c.nombre, sum(if(STRCMP(q.tipoqueja,\"lugar\") = 0,1,0)) as lugares, \n" +
            ...
            "group by c.idcronograma",nativeQuery=true)
    ArrayList<ArrayList<Object>> reportequejas1(LocalDate fechaini, LocalDate fechafin, Integer iddepartamento, Integer idprovincia, List<Integer> cronogramas);
    ...
    @Query(value="select c.idcronograma, c.nombre, sum(if(STRCMP(q.tipoqueja,\"lugar\") = 0,1,0)) as lugares, \n" +
            ...
            "group by c.idcronograma",nativeQuery=true)
    ArrayList<ArrayList<Object>> reportequejas2(LocalDate fechaini, LocalDate fechafin, Integer iddepartamento, List<Integer> cronogramas);
    ...
    @Query(value="select c.idcronograma, c.nombre, sum(if(STRCMP(q.tipoqueja,\"lugar\") = 0,1,0)) as lugares, \n" +
            ...
            "group by c.idcronograma",nativeQuery=true)
    ArrayList<ArrayList<Object>> reportequejas3(LocalDate fechaini, LocalDate fechafin,List<Integer> cronogramas);
