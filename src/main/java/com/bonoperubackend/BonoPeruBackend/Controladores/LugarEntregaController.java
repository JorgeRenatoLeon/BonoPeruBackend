    ...
    public List<Object> save(MultipartFile file, Integer idCreacion) {
        try (BufferedReader fileReader = new BufferedReader(new InputStreamReader(file.getInputStream()));
            ...
            for (CSVRecord csvRecord : csvRecords) {
                ...
                int aforo=0;
                try {
                    aforo = Integer.parseInt(csvRecord.get("AFORO"));
                }
                catch (Exception exception){
                    if(array.size()==0) array.add(Integer.toString(row));
                ...
                try {
                    ...
                    if(horasAux.length()!=0){
                        ...
                        horaFinLunesMa = LocalTime.parse(horasAux.substring(6,11)).minusHours(3);
                        horaInicioLunesTar = LocalTime.parse(horasAux.substring(14,19)).minusHours(3);
                        horaFinLunesTar = LocalTime.parse(horasAux.substring(20,25)).minusHours(3);
                    }
                }
                catch (Exception exception){
                    if(array.size()==0) array.add(Integer.toString(row));
                ...
                try {
                    ...
                    if(horasAux.length()!=0) {
                        ...
                        horaFinMartesMa = LocalTime.parse(horasAux.substring(6, 11)).minusHours(3);
                        horaInicioMartesTar = LocalTime.parse(horasAux.substring(14, 19)).minusHours(3);
                        horaFinMartesTar = LocalTime.parse(horasAux.substring(20, 25)).minusHours(3);
                    }
                }
                catch (Exception exception){
                    if(array.size()==0) array.add(Integer.toString(row));
                ...
                try {
                    ...
                    if(horasAux.length()!=0) {
                        ...
                        horaFinMiercolesMa = LocalTime.parse(horasAux.substring(6, 11)).minusHours(3);
                        horaInicioMiercolesTar = LocalTime.parse(horasAux.substring(14, 19)).minusHours(3);
                        horaFinMiercolesTar = LocalTime.parse(horasAux.substring(20, 25)).minusHours(3);
                    }
                }
                catch (Exception exception){
                    if(array.size()==0) array.add(Integer.toString(row));
                ...
                try {
                    ...
                    if(horasAux.length()!=0) {
                        ...
                        horaFinJuevesMa = LocalTime.parse(horasAux.substring(6, 11)).minusHours(3);
                        horaInicioJuevesTar = LocalTime.parse(horasAux.substring(14, 19)).minusHours(3);
                        horaFinJuevesTar = LocalTime.parse(horasAux.substring(20, 25)).minusHours(3);
                    }
                }
                catch (Exception exception){
                    if(array.size()==0) array.add(Integer.toString(row));
                ...
                try {
                    ...
                    if(horasAux.length()!=0) {
                        ...
                        horaFinViernesMa = LocalTime.parse(horasAux.substring(6, 11)).minusHours(3);
                        horaInicioViernesTar = LocalTime.parse(horasAux.substring(14, 19)).minusHours(3);
                        horaFinViernesTar = LocalTime.parse(horasAux.substring(20, 25)).minusHours(3);
                    }
                }
                catch (Exception exception){
                    if(array.size()==0) array.add(Integer.toString(row));
                ...
                try {
                    ...
                    if(horasAux.length()!=0) {
                        ...
                        horaFinSabadoMa = LocalTime.parse(horasAux.substring(6, 11)).minusHours(3);
                        horaInicioSabadoTar = LocalTime.parse(horasAux.substring(14, 19)).minusHours(3);
                        horaFinSabadoTar = LocalTime.parse(horasAux.substring(20, 25)).minusHours(3);
                ...
                try {
                    ...
                    if(horasAux.length()!=0) {
                        ...
                        horaFinDomingoMa = LocalTime.parse(horasAux.substring(6, 11)).minusHours(3);
                        horaInicioDomingoTar = LocalTime.parse(horasAux.substring(14, 19)).minusHours(3);
                        horaFinDomingoTar = LocalTime.parse(horasAux.substring(20, 25)).minusHours(3);
                ...
                Optional<Distrito> distritoAux = distritoRepository.findByUbigeo(ubigeo);
